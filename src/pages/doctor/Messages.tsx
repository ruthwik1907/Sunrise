...
export default function DoctorMessages() {
  return (
    <div className="h-[calc(100vh-10rem)] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-4 text-center">Clinical Messaging</h1>
      ...
      <p className="text-lg text-slate-500 max-w-md mx-auto leading-relaxed mb-10 text-center">
        We are building a HIPAA-compliant, secure real-time messaging system for patient consultations and internal staff coordination. 
        Soon, you'll be able to discuss cases directly with your patients and colleagues in a secure environment.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-xl mx-auto">
        <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-sm flex items-start gap-3 text-left">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900">Secure Consultation</h3>
            <p className="text-xs text-slate-500">End-to-end encrypted chats with your assigned patients.</p>
          </div>
        </div>
        <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-sm flex items-start gap-3 text-left">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900">Staff Coordination</h3>
            <p className="text-xs text-slate-500">Quickly reach nursing staff, lab techs, or the pharmacy.</p>
          </div>
        </div>
      </div>
    </div>
